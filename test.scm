...
(test-group "curve"
 (for-each (lambda (a b) (test-approximate b a (/ 44100 16))) (force-list (curve '(0 . 0) '(0.2 . -0.3) '(0.3 . 0.4) '(0.7 . 0.1) '(0.6 . 0.7) '(1 . 1) 44100)) (read (open-input-file "curve1")))
 (for-each (lambda (a b) (test-approximate b a (/ 44100 16))) (force-list (curve '(0 . 1) '(0.5 . 0.2) '(0.2 . 0.3) '(0.7 . 0.1) '(0.8 . -1) '(1 . 0) 44100)) (read (open-input-file "curve2")))
 (test-error (curve '(0 . 1) '(0.6 . 0.2) '(0.6 . 0.4) '(0.8 . 0.3) '(0.3 . -0.8) '(1 . 0))))
